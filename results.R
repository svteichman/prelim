...
pi <- read.delim(file = "data/PI_DATA.txt", na.string = c('NA', ''), stringsAsFactors = FALSE)
nrti <- read.delim(file = "data/NRTI_DATA.txt", na.string = c('NA', ''), stringsAsFactors = FALSE)
nnrti <- read.delim(file = "data/NNRTI_DATA.txt", na.string = c('NA', ''), stringsAsFactors = FALSE)
